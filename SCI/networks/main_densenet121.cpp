...
void MatAddBroadCast2(
    int64_t s1, int64_t s2, uint64_t *A, uint64_t *B, uint64_t *outArr
) {
    for (uint64_t i1 = (int32_t)0; i1 < s1; i1++) {
        for (uint64_t i2 = (int32_t)0; i2 < s2; i2++) {
            Arr2DIdxRowM(outArr, s1, s2, i1, i2) = SecretAdd(
                Arr2DIdxRowM(A, s1, s2, i1, i2), Arr1DIdxRowM(B, s2, i2)
            );
        }
    }
}
            ...
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
                for (uint64_t i4 = (int32_t)0; i4 < s4; i4++) {
                    Arr4DIdxRowM(outArr, s1, s2, s3, s4, i1, i2, i3, i4) =
                        SecretAdd(
                            Arr4DIdxRowM(A, s1, s2, s3, s4, i1, i2, i3, i4),
            ...
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
                for (uint64_t i4 = (int32_t)0; i4 < s4; i4++) {
                    for (uint64_t i5 = (int32_t)0; i5 < s5; i5++) {
                        Arr5DIdxRowM(
                            outArr, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                        ) =
                            SecretAdd(
                                Arr5DIdxRowM(
                                    A, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                                ),
                    ...
                    for (uint64_t i5 = (int32_t)0; i5 < s5; i5++) {
                        Arr5DIdxRowM(
                            ...
                            SecretAdd(
                                ...
                                Arr5DIdxRowM(
                                    B, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                                )
                            );
                    }
                }
...
void CreateTensor3(
    int64_t s1, int64_t s2, int64_t s3, int64_t val, int64_t *arr
) {
    for (uint64_t i1 = (int32_t)0; i1 < s1; i1++) {
        for (uint64_t i2 = (int32_t)0; i2 < s2; i2++) {
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
...
void CreateTensor4(
    int64_t s1, int64_t s2, int64_t s3, int64_t s4, int64_t val, int64_t *arr
) {
    for (uint64_t i1 = (int32_t)0; i1 < s1; i1++) {
        for (uint64_t i2 = (int32_t)0; i2 < s2; i2++) {
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
        ...
        for (uint64_t i2 = (int32_t)0; i2 < s2; i2++) {
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
                for (uint64_t i4 = (int32_t)0; i4 < s4; i4++) {
                    for (uint64_t i5 = (int32_t)0; i5 < s5; i5++) {
                        Arr5DIdxRowM(
                            arr, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                        ) = val;
                    }
                }
            }
...
void CopyTensor1(
    int64_t s1, uint64_t *targetArr, uint64_t *fromArr, uint64_t *ignore
) {
    for (uint64_t i1 = (int32_t)0; i1 < s1; i1++) {
...
void CreateIdentity22(
    int64_t s1, int64_t s2, uint64_t *fromArr, uint64_t *newArr
) {
    for (uint64_t i1 = (int32_t)0; i1 < s1; i1++) {
        for (uint64_t i2 = (int32_t)0; i2 < s2; i2++) {
...
void CreateIdentity33(
    int64_t s1, int64_t s2, int64_t s3, uint64_t *fromArr, uint64_t *newArr
) {
    for (uint64_t i1 = (int32_t)0; i1 < s1; i1++) {
        for (uint64_t i2 = (int32_t)0; i2 < s2; i2++) {
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
...
void CreateCopy2211(
    ...
    for (uint64_t i = (int32_t)0; i < s1; i++) {
        for (uint64_t j = (int32_t)0; j < s2; j++) {
            Arr2DIdxRowM(outArr, s1, s2, i, j) = Arr2DIdxRowM(
                inArr, inps1, inps2,
            ...
            for (uint64_t k = (int32_t)0; k < s3; k++) {
                for (uint64_t l = (int32_t)0; l < s4; l++) {
                    for (uint64_t m = (int32_t)0; m < s5; m++) {
                        Arr5DIdxRowM(
                            outArr, s1, s2, s3, s4, s5, i, j, k, l, m
                        ) =
                            Arr5DIdxRowM(
                                inArr, inps1, inps2, inps3, inps4, inps5,
                                (Arr1DIdxRowM(
                                     beginIdx, perDimSize, (int32_t)0
                                 ) +
                                 i),
                                (Arr1DIdxRowM(
                                     beginIdx, perDimSize, (int32_t)1
                                 ) +
                                 j),
                                (Arr1DIdxRowM(
                                     beginIdx, perDimSize, (int32_t)2
                                 ) +
                                 k),
                                (Arr1DIdxRowM(
                                     beginIdx, perDimSize, (int32_t)3
                                 ) +
                                 l),
                                (Arr1DIdxRowM(
                                     beginIdx, perDimSize, (int32_t)4
                                 ) +
                                 m)
                            );
                    }
                    ...
                    if ((axis == (int32_t)0)) {
                        if ((i1 < inp1s1)) {
                            Arr4DIdxRowM(outp, s1, s2, s3, s4, i1, i2, i3, i4) =
                                Arr4DIdxRowM(
                                    inp1, inp1s1, inp1s2, inp1s3, inp1s4, i1,
                                    i2, i3, i4
                                );
                        } else {
                            Arr4DIdxRowM(outp, s1, s2, s3, s4, i1, i2, i3, i4) =
                                Arr4DIdxRowM(
                                    inp2, inp2s1, inp2s2, inp2s3, inp2s4,
                                    (i1 - inp1s1), i2, i3, i4
                                );
                        }
                    } else {
                        if ((axis == (int32_t)1)) {
                            if ((i2 < inp1s2)) {
                                Arr4DIdxRowM(
                                    outp, s1, s2, s3, s4, i1, i2, i3, i4
                                ) =
                                    Arr4DIdxRowM(
                                        inp1, inp1s1, inp1s2, inp1s3, inp1s4,
                                        i1, i2, i3, i4
                                    );
                            } else {
                                Arr4DIdxRowM(
                            ...
                            if ((axis == (int32_t)2)) {
                                if ((i3 < inp1s3)) {
                                    ...
                                    Arr4DIdxRowM(
                                        ...
                                        Arr4DIdxRowM(
                                            inp2, inp2s1, inp2s2, inp2s3,
                                            inp2s4, i1, i2, (i3 - inp1s3), i4
                                        );
                                }
                            } else {
                                if ((i4 < inp1s4)) {
                ...
                for (uint64_t g = (int32_t)0; g < G; g++) {
                    for (uint64_t h = (int32_t)0; h < outH; h++) {
                        for (uint64_t w = (int32_t)0; w < outW; w++) {
                            ...
                            Arr4DIdxRowM(
                                outArr, N, outH, outW, CO, n, h, w, co
                            ) =
                                SecretAdd(
                                    Arr4DIdxRowM(
                                        outArr, N, outH, outW, CO, n, h, w, co
...
void Conv2DReshapeMatMulOPGroup(
    int64_t N,
    int64_t finalH,
    int64_t finalW,
    int64_t CO,
                    ...
                    for (uint64_t ci = (int32_t)0; ci < CI; ci++) {
                        int64_t linIdx =
                            ((((((fd * FH) * FW) * CI) + ((fh * FW) * CI)) +
                             ...
                             ci);
                        Arr2DIdxRowM(
                            outputArr, CO, (((FD * FH) * FW) * CI), co, linIdx
                        ) =
                            Arr5DIdxRowM(
                                inputArr, FD, FH, FW, CI, CO, fd, fh, fw, ci, co
                            );
                    }
                }
            }
        ...
        for (uint64_t n = (int32_t)0; n < N; n++) {
            for (uint64_t d = (int32_t)0; d < finalD; d++) {
                for (uint64_t h = (int32_t)0; h < finalH; h++) {
                    for (uint64_t w = (int32_t)0; w < finalW; w++) {
                        Arr5DIdxRowM(
                            outputArr, N, finalD, finalH, finalW, CO, n, d, h,
                            w, co
                        ) =
                            Arr2DIdxRowM(
                                inputArr, CO,
                                (((N * finalD) * finalH) * finalW), co,
            ...
            for (uint64_t d = (int32_t)0; d < outD; d++) {
                for (uint64_t h = (int32_t)0; h < outH; h++) {
                    for (uint64_t w = (int32_t)0; w < outW; w++) {
                        for (uint64_t ci = (int32_t)0; ci < CI; ci++) {
                            uint64_t val = funcSSCons((int32_t)0);
                            for (uint64_t fd = (d * strideD);
                                 fd < ((d * strideD) + FD); fd++) {
                                for (uint64_t fh = (h * strideH);
                                     fh < ((h * strideH) + FH); fh++) {
                                    for (uint64_t fw = (w * strideW);
                                         fw < ((w * strideW) + FW); fw++) {
                                        ...
                                        if (((((((curPosD >= (int32_t)0) &&
                                              ...
                                              (curPosH < H)) &&
                                             (curPosW < W))) {
                                            int64_t curFilterPosD =
                                                (fd - (d * strideD));

                                            int64_t curFilterPosH =
                                                (fh - (h * strideH));

                                            int64_t curFilterPosW =
                                                (fw - (w * strideW));
                                            val = SecretAdd(
                                                val,
                                                SecretMult(
                            ...
                            Arr5DIdxRowM(
                                outArr, N, outD, outH, outW, CO, n, d, h, w, co
                            ) =
                                SecretAdd(
                                    Arr5DIdxRowM(
                                        outArr, N, outD, outH, outW, CO, n, d,
                                        h, w, co
                                    ),
                                    val
                                );
...
void ConvTranspose2DReshapeMatMulOP(
    int64_t N,
    int64_t finalH,
    int64_t finalW,
    int64_t CO,
...
void ConvTranspose2DReshapeFilter(
    int64_t FH,
    int64_t FW,
    int64_t CO,
    int64_t CI,
        ...
        for (uint64_t fh = (int32_t)0; fh < FH; fh++) {
            for (uint64_t fw = (int32_t)0; fw < FW; fw++) {
                for (uint64_t ci = (int32_t)0; ci < CI; ci++) {
                    ...
                    Arr2DIdxRowM(outputArr, CO, ((FH * FW) * CI), co, linIdx) =
                        Arr4DIdxRowM(
                            inputArr, FH, FW, CO, CI, ((FH - (int32_t)1) - fh),
...
void ConvTranspose2DReshapeInput(
    ...
    int64_t FW,
    int64_t zPadTrHLeft,
    int64_t zPadTrHRight,
    int64_t zPadTrWLeft,
    int64_t zPadTrWRight,
    int64_t strideH,
    int64_t strideW,
    int64_t RRows,
    int64_t RCols,
...
void ConvTranspose3DReshapeFilter(
    int64_t FD,
    int64_t FH,
    int64_t FW,
    int64_t CO,
                                    ...
                                    if (((((curPosD < (int32_t)0) ||
                                        ...
                                        if (((((curPosD % strideD) == (int32_t)0
                                            ...
                                            int64_t idxInputW =
                                                (curPosW / strideW);
                                            val = Arr5DIdxRowM(
                                                inputArr, N, DPrime, HPrime,
                                                WPrime, CI, n, idxInputD,
                                                idxInputH, idxInputW, ci
                                            );
                                        } else {
                                            val = funcSSCons((int32_t)0);
                            ...
                            for (uint64_t fd = d; fd < (d + FD); fd++) {
                                for (uint64_t fh = h; fh < (h + FH); fh++) {
                                    for (uint64_t fw = w; fw < (w + FW); fw++) {
                                        int64_t curPosD =
                                            ((fd - zPadDLeft) / strideD);

                                        int64_t curPosH =
                                            ((fh - zPadHLeft) / strideD);

                                        int64_t curPosW =
                                            ((fw - zPadWLeft) / strideD);
                                        if ((((((((((curPosD >= (int32_t)0) &&
                                                    (curPosH >= (int32_t)0)) &&
                                                   (curPosW >= (int32_t)0)) &&
                                                  (curPosD < D)) &&
                                               ...
                                               (((fd - zPadDLeft) % strideD) ==
                                                (int32_t)0)) &&
                                              (((fh - zPadHLeft) % strideH) ==
                                               (int32_t)0)) &&
                                             (((fw - zPadWLeft) % strideW) ==
                                              (int32_t)0))) {
                                            int64_t curFilterPosD =
                                                (((FD + d) - fd) - (int32_t)1);
                ...
                for (uint64_t l = (int32_t)0; l < s4; l++) {
                    if (((((((((i >= lbounds1) && (i < rbounds1excl)) &&
                        ...
                        Arr4DIdxRowM(outArr, s1, s2, s3, s4, i, j, k, l) =
                            Arr4DIdxRowM(
                                inpArr, inps1, inps2, inps3, inps4,
                                (i - Arr2DIdxRowM(
                                         paddings, pads1, pads2, (int32_t)0,
                                         (int32_t)0
                                     )),
                                (j - Arr2DIdxRowM(
                                         paddings, pads1, pads2, (int32_t)1,
                                         (int32_t)0
                                     )),
                                (k - Arr2DIdxRowM(
                                         paddings, pads1, pads2, (int32_t)2,
                                         (int32_t)0
                                     )),
                                (l - Arr2DIdxRowM(
                                         paddings, pads1, pads2, (int32_t)3,
                                         (int32_t)0
                                     ))
                            );
                    } else {
                        ...
                        if (((((((((((i >= lbounds1) && (i < rbounds1excl)) &&
                            ...
                            Arr5DIdxRowM(
                                ...
                                Arr5DIdxRowM(
                                    ...
                                    (m - Arr2DIdxRowM(
                                             paddings, pads1, pads2, (int32_t)4,
                                             (int32_t)0
                                         ))
                                );
                        } else {
...
void FusedBatchNorm4411(
    ...
    uint64_t *multArr,
    uint64_t *biasArr,
    int64_t multExprScaleDownSf,
    int64_t biasExprScaleUpSf,
    uint64_t *outputArr
) {
            ...
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
                for (uint64_t i4 = (int32_t)0; i4 < s4; i4++) {
                    ...
                    Arr4DIdxRowM(outputArr, s1, s2, s3, s4, i1, i2, i3, i4) =
                        SecretAdd(
                            Arr1DIdxRowM(multExprAns, inpSize, linIdx),
            ...
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
                for (uint64_t i4 = (int32_t)0; i4 < s4; i4++) {
                    for (uint64_t i5 = (int32_t)0; i5 < s5; i5++) {
                        ...
                        Arr1DIdxRowM(inArrReshaped, inpSize, linIdx) =
                            Arr5DIdxRowM(
                                inArr, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                            );
                        Arr1DIdxRowM(multArrReshaped, inpSize, linIdx) =
                    ...
                    for (uint64_t i5 = (int32_t)0; i5 < s5; i5++) {
                        int64_t linIdx =
                            ((((((((i1 * s2) * s3) * s4) * s5) +
                             ...
                             i5);
                        Arr5DIdxRowM(
                            outputArr, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                        ) =
                            SecretAdd(
                                Arr1DIdxRowM(multExprAns, inpSize, linIdx),
...
void ElemWiseMul2(
    int64_t s1, int64_t s2, uint64_t *arr1, uint64_t *arr2, uint64_t *outArr
) {
            ...
            for (uint64_t i3 = (int32_t)0; i3 < s3; i3++) {
                for (uint64_t i4 = (int32_t)0; i4 < s4; i4++) {
                    for (uint64_t i5 = (int32_t)0; i5 < s5; i5++) {
                        ...
                        Arr1DIdxRowM(arr1Reshaped, inpSize, linIdx) =
                            Arr5DIdxRowM(
                                arr1, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                            );
                        Arr1DIdxRowM(arr2Reshaped, inpSize, linIdx) =
                            Arr5DIdxRowM(
                                arr2, s1, s2, s3, s4, s5, i1, i2, i3, i4, i5
                            );
                    }
                }
            }
...
void ReduceMean24(
        ...
        for (uint64_t i2 = (int32_t)0; i2 < outS2; i2++) {
            ...
            for (uint64_t i = (int32_t)0; i < inS2; i++) {
                for (uint64_t j = (int32_t)0; j < inS3; j++) {
                    summ = SecretAdd(
                        summ, Arr4DIdxRowM(
                                  inputArr, inS1, inS2, inS3, inS4, i1, i, j, i2
                              )
                    );
                }
            }
    ...
    for (uint64_t i1 = (int32_t)0; i1 < outS1; i1++) {
        for (uint64_t i2 = (int32_t)0; i2 < outS2; i2++) {
            Arr2DIdxRowM(outputArr, outS1, outS2, i1, i2) = Arr1DIdxRowM(
                outputArrReshaped, outputSize, ((i1 * outS2) + i2)
            );
        }
    }
        ...
        for (uint64_t i2 = (int32_t)0; i2 < outS2; i2++) {
            ...
            for (uint64_t i = (int32_t)0; i < inS3; i++) {
                for (uint64_t j = (int32_t)0; j < inS4; j++) {
                    summ = SecretAdd(
                        summ, Arr4DIdxRowM(
                                  inputArr, inS1, inS2, inS3, inS4, i1, i2, i, j
                              )
                    );
                }
            }
        ...
        for (uint64_t i2 = (int32_t)0; i2 < ins2; i2++) {
            for (uint64_t i3 = (int32_t)0; i3 < ins3; i3++) {
                for (uint64_t i4 = (int32_t)0; i4 < ins4; i4++) {
                    int64_t linIdx =
                        ((((i1 * ins2) * ins3) + (i2 * ins3)) + i3);
                    Arr2DIdxRowM(reshapedInArr, size, ins4, linIdx, i4) =
                        Arr4DIdxRowM(
                            inArr, ins1, ins2, ins3, ins4, i1, i2, i3, i4
                        );
                }
            }
        }
...
void Floor2(
    int64_t s1, int64_t s2, uint64_t *inArr, uint64_t *outArr, int64_t sf
) {
    int64_t size = (s1 * s2);
...
void ScaleUp4(
    int64_t s1, int64_t s2, int64_t s3, int64_t s4, uint64_t *arr, int64_t sf
) {
    int64_t size = (((s1 * s2) * s3) * s4);
...
int main(int argc, char **argv) {
    ...
    uint64_t *tmp0 = make_array<uint64_t>(
        (int32_t)1, (int32_t)224, (int32_t)224, (int32_t)3
    );
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)224; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)224; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)3; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp0, (int32_t)1, (int32_t)224, (int32_t)224,
                        (int32_t)3, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)7; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)3; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)64; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp1, (int32_t)7, (int32_t)7, (int32_t)3, (int32_t)64,
                        i0, i1, i2, i3
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp2, (int32_t)64, i0) =
            (party == SERVER) ? __tmp_in_tmp2 : 0;
    }
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp3, (int32_t)64, i0) =
            (party == SERVER) ? __tmp_in_tmp3 : 0;
    }
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp4, (int32_t)64, i0) =
            (party == SERVER) ? __tmp_in_tmp4 : 0;
    }
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp5, (int32_t)64, i0) =
            (party == SERVER) ? __tmp_in_tmp5 : 0;
    }
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp6, (int32_t)64, i0) =
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp7, (int32_t)64, i0) =
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp8, (int32_t)64, i0) =
    ...
    for (uint64_t i0 = (uint64_t)0; i0 < (int32_t)64; i0++) {
        ...
        Arr1DIdxRowM(tmp9, (int32_t)64, i0) =
            (party == SERVER) ? __tmp_in_tmp9 : 0;
    }

    uint64_t *tmp10 =
        make_array<uint64_t>((int32_t)1, (int32_t)1, (int32_t)64, (int32_t)128);
    /* Variable to read the clear value corresponding to the input variable
     * tmp10 at (1960,1-1960,46) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)64; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp10, (int32_t)1, (int32_t)1, (int32_t)64,
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp15, (int32_t)3, (int32_t)3, (int32_t)128,
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)96; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp20, (int32_t)1, (int32_t)1, (int32_t)96,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp25, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp30 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)128, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp30 at (2020,1-2020,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp30, (int32_t)1, (int32_t)1, (int32_t)128,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp35, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp40 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)160, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp40 at (2050,1-2050,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)160; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp40, (int32_t)1, (int32_t)1, (int32_t)160,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp45, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp50 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)192, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp50 at (2080,1-2080,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)192; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp50, (int32_t)1, (int32_t)1, (int32_t)192,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp55, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp60 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)224, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp60 at (2110,1-2110,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)224; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp60, (int32_t)1, (int32_t)1, (int32_t)224,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp65, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp70 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)256, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp70 at (2140,1-2140,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)256; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp70, (int32_t)1, (int32_t)1, (int32_t)256,
                        (int32_t)128, i0, i1, i2, i3
    ...
    uint64_t *tmp75 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)128, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp75 at (2155,1-2155,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp75, (int32_t)1, (int32_t)1, (int32_t)128,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp80, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp85 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)160, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp85 at (2185,1-2185,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)160; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp85, (int32_t)1, (int32_t)1, (int32_t)160,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp90, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp95 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)192, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp95 at (2215,1-2215,47) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)192; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp95, (int32_t)1, (int32_t)1, (int32_t)192,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp100, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp105 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)224, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp105 at (2245,1-2245,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)224; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp105, (int32_t)1, (int32_t)1, (int32_t)224,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp110, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp115 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)256, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp115 at (2275,1-2275,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)256; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp115, (int32_t)1, (int32_t)1, (int32_t)256,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp120, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp125 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)288, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp125 at (2305,1-2305,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)288; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp125, (int32_t)1, (int32_t)1, (int32_t)288,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp130, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp135 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)320, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp135 at (2335,1-2335,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)320; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp135, (int32_t)1, (int32_t)1, (int32_t)320,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp140, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp145 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)352, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp145 at (2365,1-2365,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)352; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp145, (int32_t)1, (int32_t)1, (int32_t)352,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp150, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp155 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)384, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp155 at (2395,1-2395,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)384; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp155, (int32_t)1, (int32_t)1, (int32_t)384,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp160, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp165 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)416, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp165 at (2425,1-2425,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)416; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp165, (int32_t)1, (int32_t)1, (int32_t)416,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp170, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp175 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)448, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp175 at (2455,1-2455,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)448; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp175, (int32_t)1, (int32_t)1, (int32_t)448,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp180, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp185 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)480, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp185 at (2485,1-2485,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)480; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp185, (int32_t)1, (int32_t)1, (int32_t)480,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp190, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp195 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)512, (int32_t)256
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp195 at (2515,1-2515,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)512; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)256; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp195, (int32_t)1, (int32_t)1, (int32_t)512,
    ...
    uint64_t *tmp200 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)256, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp200 at (2530,1-2530,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)256; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp200, (int32_t)1, (int32_t)1, (int32_t)256,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp205, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp210 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)288, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp210 at (2560,1-2560,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)288; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp210, (int32_t)1, (int32_t)1, (int32_t)288,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp215, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp220 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)320, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp220 at (2590,1-2590,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)320; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp220, (int32_t)1, (int32_t)1, (int32_t)320,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp225, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp230 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)352, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp230 at (2620,1-2620,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)352; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp230, (int32_t)1, (int32_t)1, (int32_t)352,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp235, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp240 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)384, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp240 at (2650,1-2650,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)384; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp240, (int32_t)1, (int32_t)1, (int32_t)384,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp245, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp250 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)416, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp250 at (2680,1-2680,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)416; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp250, (int32_t)1, (int32_t)1, (int32_t)416,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp255, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp260 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)448, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp260 at (2710,1-2710,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)448; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp260, (int32_t)1, (int32_t)1, (int32_t)448,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp265, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp270 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)480, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp270 at (2740,1-2740,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)480; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp270, (int32_t)1, (int32_t)1, (int32_t)480,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp275, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp280 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)512, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp280 at (2770,1-2770,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)512; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp280, (int32_t)1, (int32_t)1, (int32_t)512,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp285, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp290 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)544, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp290 at (2800,1-2800,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)544; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp290, (int32_t)1, (int32_t)1, (int32_t)544,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp295, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp300 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)576, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp300 at (2830,1-2830,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)576; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp300, (int32_t)1, (int32_t)1, (int32_t)576,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp305, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp310 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)608, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp310 at (2860,1-2860,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)608; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp310, (int32_t)1, (int32_t)1, (int32_t)608,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp315, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp320 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)640, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp320 at (2890,1-2890,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)640; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp320, (int32_t)1, (int32_t)1, (int32_t)640,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp325, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp330 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)672, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp330 at (2920,1-2920,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)672; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp330, (int32_t)1, (int32_t)1, (int32_t)672,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp335, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp340 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)704, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp340 at (2950,1-2950,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)704; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp340, (int32_t)1, (int32_t)1, (int32_t)704,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp345, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp350 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)736, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp350 at (2980,1-2980,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)736; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp350, (int32_t)1, (int32_t)1, (int32_t)736,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp355, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp360 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)768, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp360 at (3010,1-3010,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)768; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp360, (int32_t)1, (int32_t)1, (int32_t)768,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp365, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp370 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)800, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp370 at (3040,1-3040,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)800; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp370, (int32_t)1, (int32_t)1, (int32_t)800,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp375, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp380 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)832, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp380 at (3070,1-3070,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)832; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp380, (int32_t)1, (int32_t)1, (int32_t)832,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp385, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp390 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)864, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp390 at (3100,1-3100,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)864; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp390, (int32_t)1, (int32_t)1, (int32_t)864,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp395, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp400 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)896, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp400 at (3130,1-3130,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)896; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp400, (int32_t)1, (int32_t)1, (int32_t)896,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp405, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp410 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)928, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp410 at (3160,1-3160,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)928; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp410, (int32_t)1, (int32_t)1, (int32_t)928,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp415, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp420 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)960, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp420 at (3190,1-3190,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)960; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp420, (int32_t)1, (int32_t)1, (int32_t)960,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp425, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp430 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)992, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp430 at (3220,1-3220,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)992; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp430, (int32_t)1, (int32_t)1, (int32_t)992,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp435, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp440 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)1024, (int32_t)512
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp440 at (3250,1-3250,49) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)1024; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)512; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp440, (int32_t)1, (int32_t)1, (int32_t)1024,
    ...
    uint64_t *tmp445 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)512, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp445 at (3265,1-3265,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)512; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp445, (int32_t)1, (int32_t)1, (int32_t)512,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp450, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp455 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)544, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp455 at (3295,1-3295,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)544; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp455, (int32_t)1, (int32_t)1, (int32_t)544,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp460, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp465 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)576, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp465 at (3325,1-3325,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)576; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp465, (int32_t)1, (int32_t)1, (int32_t)576,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp470, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp475 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)608, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp475 at (3355,1-3355,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)608; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp475, (int32_t)1, (int32_t)1, (int32_t)608,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp480, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp485 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)640, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp485 at (3385,1-3385,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)640; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp485, (int32_t)1, (int32_t)1, (int32_t)640,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp490, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp495 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)672, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp495 at (3415,1-3415,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)672; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp495, (int32_t)1, (int32_t)1, (int32_t)672,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp500, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp505 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)704, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp505 at (3445,1-3445,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)704; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp505, (int32_t)1, (int32_t)1, (int32_t)704,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp510, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp515 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)736, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp515 at (3475,1-3475,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)736; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp515, (int32_t)1, (int32_t)1, (int32_t)736,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp520, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp525 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)768, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp525 at (3505,1-3505,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)768; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp525, (int32_t)1, (int32_t)1, (int32_t)768,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp530, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp535 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)800, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp535 at (3535,1-3535,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)800; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp535, (int32_t)1, (int32_t)1, (int32_t)800,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp540, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp545 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)832, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp545 at (3565,1-3565,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)832; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp545, (int32_t)1, (int32_t)1, (int32_t)832,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp550, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp555 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)864, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp555 at (3595,1-3595,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)864; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp555, (int32_t)1, (int32_t)1, (int32_t)864,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp560, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp565 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)896, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp565 at (3625,1-3625,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)896; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp565, (int32_t)1, (int32_t)1, (int32_t)896,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp570, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp575 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)928, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp575 at (3655,1-3655,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)928; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp575, (int32_t)1, (int32_t)1, (int32_t)928,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp580, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp585 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)960, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp585 at (3685,1-3685,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)960; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp585, (int32_t)1, (int32_t)1, (int32_t)960,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp590, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp595 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)992, (int32_t)128
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp595 at (3715,1-3715,48) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)992; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)128; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp595, (int32_t)1, (int32_t)1, (int32_t)992,
                        (int32_t)128, i0, i1, i2, i3
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)3; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)128; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)32; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp600, (int32_t)3, (int32_t)3, (int32_t)128,
                        (int32_t)32, i0, i1, i2, i3
    ...
    uint64_t *tmp605 = make_array<uint64_t>(
        (int32_t)1, (int32_t)1, (int32_t)1024, (int32_t)1000
    );
    /* Variable to read the clear value corresponding to the input variable
     * tmp605 at (3745,1-3745,50) */
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)1024; i2++) {
                for (uint64_t i3 = (uint64_t)0; i3 < (int32_t)1000; i3++) {
                    ...
                    Arr4DIdxRowM(
                        tmp605, (int32_t)1, (int32_t)1, (int32_t)1024,
    ...
    uint64_t *tmp607 = make_array<uint64_t>(
        (int32_t)1, (int32_t)112, (int32_t)112, (int32_t)64
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)224, (int32_t)224, (int32_t)3, (int32_t)7,
        (int32_t)7, (int32_t)64, (int32_t)2, (int32_t)3, (int32_t)2, (int32_t)3,
        (int32_t)2, (int32_t)2, tmp0, tmp1, tmp607
    );
    ...
    uint64_t *tmp610 = make_array<uint64_t>(
        (int32_t)1, (int32_t)112, (int32_t)112, (int32_t)64
    );
    ScaleDown4(
        (int32_t)1, (int32_t)112, (int32_t)112, (int32_t)64, tmp607, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)112, (int32_t)112, (int32_t)64, tmp607, tmp2, tmp3,
        (int32_t)0, kScale, tmp610
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)112, (int32_t)112, (int32_t)64, tmp607
    );
    ...
    MaxPool(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64, (int32_t)3,
        (int32_t)3, (int32_t)0, (int32_t)1, (int32_t)0, (int32_t)1, (int32_t)2,
        (int32_t)2, (int32_t)1, (int32_t)112, (int32_t)112, (int32_t)64, tmp610,
        tmp614
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)112, (int32_t)112, (int32_t)64, tmp610
    );

    uint64_t *tmp616 =
        make_array<uint64_t>((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64);
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64, tmp614, tmp616,
        kScale, 1
    );
    ...
    uint64_t *tmp618 =
        make_array<uint64_t>((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64, tmp616, tmp6, tmp7,
        (int32_t)0, kScale, tmp618
    );
    ...
    uint64_t *tmp621 =
        make_array<uint64_t>((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64);
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64, tmp618, tmp621,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)64, tmp618);

    uint64_t *tmp623 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Conv2DWrapper(
    ...
    uint64_t *tmp626 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp623, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp623, tmp11,
        tmp12, (int32_t)0, kScale, tmp626
    );
    ...
    uint64_t *tmp630 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp626, tmp630,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp630, tmp15, tmp632
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)32, tmp632, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)96, (int32_t)1,
        (int32_t)56, (int32_t)56, (int32_t)64, tmp616, (int32_t)1, (int32_t)56,
        (int32_t)56, (int32_t)32, tmp632, tmp635, tmp636
    );
    ...
    uint64_t *tmp640 =
        make_array<uint64_t>((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)96);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)96, tmp636, tmp16, tmp17,
        (int32_t)0, kScale, tmp640
    );
    ...
    uint64_t *tmp643 =
        make_array<uint64_t>((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)96);
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)96, tmp640, tmp643,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)96, tmp640);

    uint64_t *tmp645 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)96, (int32_t)1,
    ...
    uint64_t *tmp648 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp645, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp645, tmp21,
        tmp22, (int32_t)0, kScale, tmp648
    );
    ...
    uint64_t *tmp652 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp648, tmp652,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp652, tmp25, tmp654
    );
    ...
    uint64_t *tmp658 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)32, tmp654, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)1,
        (int32_t)56, (int32_t)56, (int32_t)96, tmp636, (int32_t)1, (int32_t)56,
        (int32_t)56, (int32_t)32, tmp654, tmp657, tmp658
    );
    ...
    uint64_t *tmp662 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp658, tmp26,
        tmp27, (int32_t)0, kScale, tmp662
    );
    ClearMemSecret1((int32_t)128, tmp27);
    ClearMemSecret1((int32_t)128, tmp26);

    uint64_t *tmp665 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp662, tmp665,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp662);

    uint64_t *tmp667 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)1,
    ...
    uint64_t *tmp670 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp667, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp667, tmp31,
        tmp32, (int32_t)0, kScale, tmp670
    );
    ...
    uint64_t *tmp674 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp670, tmp674,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp674, tmp35, tmp676
    );
    ...
    uint64_t *tmp680 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)32, tmp676, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160, (int32_t)1,
        (int32_t)56, (int32_t)56, (int32_t)128, tmp658, (int32_t)1, (int32_t)56,
        (int32_t)56, (int32_t)32, tmp676, tmp679, tmp680
    );
    ...
    uint64_t *tmp684 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160, tmp680, tmp36,
        tmp37, (int32_t)0, kScale, tmp684
    );
    ClearMemSecret1((int32_t)160, tmp37);
    ClearMemSecret1((int32_t)160, tmp36);

    uint64_t *tmp687 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160, tmp684, tmp687,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160, tmp684);

    uint64_t *tmp689 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)160, (int32_t)1,
    ...
    uint64_t *tmp692 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp689, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp689, tmp41,
        tmp42, (int32_t)0, kScale, tmp692
    );
    ...
    uint64_t *tmp696 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp692, tmp696,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp696, tmp45, tmp698
    );
    ...
    uint64_t *tmp702 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)32, tmp698, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192, (int32_t)1,
        (int32_t)56, (int32_t)56, (int32_t)160, tmp680, (int32_t)1, (int32_t)56,
        (int32_t)56, (int32_t)32, tmp698, tmp701, tmp702
    );
    ...
    uint64_t *tmp706 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192, tmp702, tmp46,
        tmp47, (int32_t)0, kScale, tmp706
    );
    ClearMemSecret1((int32_t)192, tmp47);
    ClearMemSecret1((int32_t)192, tmp46);

    uint64_t *tmp709 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192, tmp706, tmp709,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192, tmp706);

    uint64_t *tmp711 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)192, (int32_t)1,
    ...
    uint64_t *tmp714 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp711, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp711, tmp51,
        tmp52, (int32_t)0, kScale, tmp714
    );
    ...
    uint64_t *tmp718 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp714, tmp718,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp718, tmp55, tmp720
    );
    ...
    uint64_t *tmp724 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)32, tmp720, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224, (int32_t)1,
        (int32_t)56, (int32_t)56, (int32_t)192, tmp702, (int32_t)1, (int32_t)56,
        (int32_t)56, (int32_t)32, tmp720, tmp723, tmp724
    );
    ...
    uint64_t *tmp728 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224, tmp724, tmp56,
        tmp57, (int32_t)0, kScale, tmp728
    );
    ClearMemSecret1((int32_t)224, tmp56);
    ClearMemSecret1((int32_t)224, tmp57);

    uint64_t *tmp731 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224, tmp728, tmp731,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224, tmp728);

    uint64_t *tmp733 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)224, (int32_t)1,
    ...
    uint64_t *tmp736 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp733, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp733, tmp61,
        tmp62, (int32_t)0, kScale, tmp736
    );
    ...
    uint64_t *tmp740 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp736, tmp740,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp740, tmp65, tmp742
    );
    ...
    uint64_t *tmp746 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256
    );
    ScaleDown4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)32, tmp742, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256, (int32_t)1,
        (int32_t)56, (int32_t)56, (int32_t)224, tmp724, (int32_t)1, (int32_t)56,
        (int32_t)56, (int32_t)32, tmp742, tmp745, tmp746
    );
    ...
    uint64_t *tmp750 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256, tmp746, tmp66,
        tmp67, (int32_t)0, kScale, tmp750
    );
    ...
    uint64_t *tmp754 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256
    );
    Relu4(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256, tmp750, tmp754,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256, tmp750);

    uint64_t *tmp756 = make_array<uint64_t>(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)256, (int32_t)1,
    ...
    uint64_t *tmp759 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    AvgPool(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)2,
        (int32_t)2, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)2,
        (int32_t)2, (int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp756,
        tmp759
    );
    ClearMemSecret4((int32_t)1, (int32_t)56, (int32_t)56, (int32_t)128, tmp756);

    uint64_t *tmp761 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp759, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp759, tmp71,
        tmp72, (int32_t)0, kScale, tmp761
    );
    ClearMemSecret1((int32_t)128, tmp72);
    ClearMemSecret1((int32_t)128, tmp71);

    uint64_t *tmp764 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp761, tmp764,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp761);

    uint64_t *tmp766 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)1,
        (int32_t)1, (int32_t)128, (int32_t)0, (int32_t)0, (int32_t)0,
    ...
    uint64_t *tmp769 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp766, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp766, tmp76,
        tmp77, (int32_t)0, kScale, tmp769
    );
    ...
    uint64_t *tmp773 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp769, tmp773,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp773, tmp80, tmp775
    );
    ...
    uint64_t *tmp779 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp775, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)128, tmp759, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp775, tmp778, tmp779
    );
    ...
    uint64_t *tmp783 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160, tmp779, tmp81,
        tmp82, (int32_t)0, kScale, tmp783
    );
    ClearMemSecret1((int32_t)160, tmp82);
    ClearMemSecret1((int32_t)160, tmp81);

    uint64_t *tmp786 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160, tmp783, tmp786,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160, tmp783);

    uint64_t *tmp788 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)160, (int32_t)1,
    ...
    uint64_t *tmp791 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp788, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp788, tmp86,
        tmp87, (int32_t)0, kScale, tmp791
    );
    ...
    uint64_t *tmp795 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp791, tmp795,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp795, tmp90, tmp797
    );
    ...
    uint64_t *tmp801 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp797, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)160, tmp779, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp797, tmp800, tmp801
    );
    ...
    uint64_t *tmp805 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192, tmp801, tmp91,
        tmp92, (int32_t)0, kScale, tmp805
    );
    ClearMemSecret1((int32_t)192, tmp92);
    ClearMemSecret1((int32_t)192, tmp91);

    uint64_t *tmp808 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192, tmp805, tmp808,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192, tmp805);

    uint64_t *tmp810 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)192, (int32_t)1,
    ...
    uint64_t *tmp813 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp810, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp810, tmp96,
        tmp97, (int32_t)0, kScale, tmp813
    );
    ...
    uint64_t *tmp817 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp813, tmp817,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp817, tmp100, tmp819
    );
    ...
    uint64_t *tmp823 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp819, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)192, tmp801, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp819, tmp822, tmp823
    );
    ...
    uint64_t *tmp827 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224, tmp823, tmp101,
        tmp102, (int32_t)0, kScale, tmp827
    );
    ClearMemSecret1((int32_t)224, tmp102);
    ClearMemSecret1((int32_t)224, tmp101);

    uint64_t *tmp830 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224, tmp827, tmp830,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224, tmp827);

    uint64_t *tmp832 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)224, (int32_t)1,
    ...
    uint64_t *tmp835 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp832, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp832, tmp106,
        tmp107, (int32_t)0, kScale, tmp835
    );
    ...
    uint64_t *tmp839 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp835, tmp839,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp839, tmp110, tmp841
    );
    ...
    uint64_t *tmp845 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp841, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)224, tmp823, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp841, tmp844, tmp845
    );
    ...
    uint64_t *tmp849 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256, tmp845, tmp111,
        tmp112, (int32_t)0, kScale, tmp849
    );
    ClearMemSecret1((int32_t)256, tmp111);
    ClearMemSecret1((int32_t)256, tmp112);

    uint64_t *tmp852 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256, tmp849, tmp852,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256, tmp849);

    uint64_t *tmp854 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256, (int32_t)1,
    ...
    uint64_t *tmp857 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp854, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp854, tmp116,
        tmp117, (int32_t)0, kScale, tmp857
    );
    ...
    uint64_t *tmp861 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp857, tmp861,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp861, tmp120, tmp863
    );
    ...
    uint64_t *tmp867 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp863, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)256, tmp845, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp863, tmp866, tmp867
    );
    ...
    uint64_t *tmp871 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288, tmp867, tmp121,
        tmp122, (int32_t)0, kScale, tmp871
    );
    ClearMemSecret1((int32_t)288, tmp121);
    ClearMemSecret1((int32_t)288, tmp122);

    uint64_t *tmp874 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288, tmp871, tmp874,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288, tmp871);

    uint64_t *tmp876 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)288, (int32_t)1,
    ...
    uint64_t *tmp879 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp876, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp876, tmp126,
        tmp127, (int32_t)0, kScale, tmp879
    );
    ...
    uint64_t *tmp883 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp879, tmp883,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp883, tmp130, tmp885
    );
    ...
    uint64_t *tmp889 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp885, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)288, tmp867, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp885, tmp888, tmp889
    );
    ...
    uint64_t *tmp893 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320, tmp889, tmp131,
        tmp132, (int32_t)0, kScale, tmp893
    );
    ClearMemSecret1((int32_t)320, tmp131);
    ClearMemSecret1((int32_t)320, tmp132);

    uint64_t *tmp896 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320, tmp893, tmp896,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320, tmp893);

    uint64_t *tmp898 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)320, (int32_t)1,
    ...
    uint64_t *tmp901 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp898, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp898, tmp136,
        tmp137, (int32_t)0, kScale, tmp901
    );
    ...
    uint64_t *tmp905 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp901, tmp905,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp905, tmp140, tmp907
    );
    ...
    uint64_t *tmp911 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp907, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)320, tmp889, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp907, tmp910, tmp911
    );
    ...
    uint64_t *tmp915 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352, tmp911, tmp141,
        tmp142, (int32_t)0, kScale, tmp915
    );
    ClearMemSecret1((int32_t)352, tmp142);
    ClearMemSecret1((int32_t)352, tmp141);

    uint64_t *tmp918 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352, tmp915, tmp918,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352, tmp915);

    uint64_t *tmp920 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)352, (int32_t)1,
    ...
    uint64_t *tmp923 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp920, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp920, tmp146,
        tmp147, (int32_t)0, kScale, tmp923
    );
    ...
    uint64_t *tmp927 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp923, tmp927,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp927, tmp150, tmp929
    );
    ...
    uint64_t *tmp933 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp929, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)352, tmp911, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp929, tmp932, tmp933
    );
    ...
    uint64_t *tmp937 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384, tmp933, tmp151,
        tmp152, (int32_t)0, kScale, tmp937
    );
    ClearMemSecret1((int32_t)384, tmp152);
    ClearMemSecret1((int32_t)384, tmp151);

    uint64_t *tmp940 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384, tmp937, tmp940,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384, tmp937);

    uint64_t *tmp942 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)384, (int32_t)1,
    ...
    uint64_t *tmp945 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp942, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp942, tmp156,
        tmp157, (int32_t)0, kScale, tmp945
    );
    ...
    uint64_t *tmp949 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp945, tmp949,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp949, tmp160, tmp951
    );
    ...
    uint64_t *tmp955 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp951, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)384, tmp933, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp951, tmp954, tmp955
    );
    ...
    uint64_t *tmp959 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416, tmp955, tmp161,
        tmp162, (int32_t)0, kScale, tmp959
    );
    ClearMemSecret1((int32_t)416, tmp161);
    ClearMemSecret1((int32_t)416, tmp162);

    uint64_t *tmp962 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416, tmp959, tmp962,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416, tmp959);

    uint64_t *tmp964 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)416, (int32_t)1,
    ...
    uint64_t *tmp967 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp964, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp964, tmp166,
        tmp167, (int32_t)0, kScale, tmp967
    );
    ...
    uint64_t *tmp971 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp967, tmp971,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp971, tmp170, tmp973
    );
    ...
    uint64_t *tmp977 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp973, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)416, tmp955, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp973, tmp976, tmp977
    );
    ...
    uint64_t *tmp981 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448, tmp977, tmp171,
        tmp172, (int32_t)0, kScale, tmp981
    );
    ClearMemSecret1((int32_t)448, tmp172);
    ClearMemSecret1((int32_t)448, tmp171);

    uint64_t *tmp984 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448, tmp981, tmp984,
        kScale, 1
    );
    ClearMemSecret4((int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448, tmp981);

    uint64_t *tmp986 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)448, (int32_t)1,
    ...
    uint64_t *tmp989 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp986, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp986, tmp176,
        tmp177, (int32_t)0, kScale, tmp989
    );
    ...
    uint64_t *tmp993 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp989, tmp993,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp993, tmp180, tmp995
    );
    ...
    uint64_t *tmp999 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp995, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)448, tmp977, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp995, tmp998, tmp999
    );
    ...
    uint64_t *tmp1003 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480, tmp999, tmp181,
        tmp182, (int32_t)0, kScale, tmp1003
    );
    ClearMemSecret1((int32_t)480, tmp182);
    ClearMemSecret1((int32_t)480, tmp181);

    uint64_t *tmp1006 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480, tmp1003, tmp1006,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480, tmp1003
    );

    uint64_t *tmp1008 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)480, tmp1006
    );

    uint64_t *tmp1011 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp1008, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp1008, tmp186,
        tmp187, (int32_t)0, kScale, tmp1011
    );
    ClearMemSecret1((int32_t)128, tmp186);
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp1008
    );
    ClearMemSecret1((int32_t)128, tmp187);

    uint64_t *tmp1015 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp1011, tmp1015,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp1011
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1015, tmp190, tmp1017
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp190);
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)128, tmp1015
    );

    int64_t tmp1020 = (int32_t)3;

    uint64_t *tmp1021 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512
    );
    ScaleDown4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32, tmp1017, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512, (int32_t)1,
        (int32_t)28, (int32_t)28, (int32_t)480, tmp999, (int32_t)1, (int32_t)28,
        (int32_t)28, (int32_t)32, tmp1017, tmp1020, tmp1021
    );
    ...
    uint64_t *tmp1025 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512, tmp1021, tmp191,
        tmp192, (int32_t)0, kScale, tmp1025
    );
    ClearMemSecret1((int32_t)512, tmp192);
    ClearMemSecret1((int32_t)512, tmp191);
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512, tmp1021
    );

    uint64_t *tmp1029 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512
    );
    Relu4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512, tmp1025, tmp1029,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512, tmp1025
    );

    uint64_t *tmp1031 = make_array<uint64_t>(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)512, tmp1029
    );

    uint64_t *tmp1034 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256
    );
    AvgPool(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256, (int32_t)2,
        (int32_t)2, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)2,
        (int32_t)2, (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256, tmp1031,
        tmp1034
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)256, tmp1031
    );

    uint64_t *tmp1036 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256, tmp1034, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256, tmp1034, tmp196,
        tmp197, (int32_t)0, kScale, tmp1036
    );
    ClearMemSecret1((int32_t)256, tmp197);
    ClearMemSecret1((int32_t)256, tmp196);

    uint64_t *tmp1039 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256
    );
    Relu4(
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256, tmp1036
    );

    uint64_t *tmp1041 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256, (int32_t)1,
        (int32_t)1, (int32_t)128, (int32_t)0, (int32_t)0, (int32_t)0,
        (int32_t)0, (int32_t)1, (int32_t)1, tmp1039, tmp200, tmp1041
    );
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)256, (int32_t)128, tmp200);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256, tmp1039
    );

    uint64_t *tmp1044 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1041, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1041, tmp201,
        tmp202, (int32_t)0, kScale, tmp1044
    );
    ClearMemSecret1((int32_t)128, tmp202);
    ClearMemSecret1((int32_t)128, tmp201);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1041
    );

    uint64_t *tmp1048 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1044, tmp1048,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1044
    );

    uint64_t *tmp1050 =
        make_array<uint64_t>((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32);
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1048, tmp205, tmp1050
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1048
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp205);

    int64_t tmp1053 = (int32_t)3;

    uint64_t *tmp1054 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1050, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)256, tmp1034
    );
    ClearMemPublic(tmp1053);

    uint64_t *tmp1058 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288, tmp1054, tmp206,
        tmp207, (int32_t)0, kScale, tmp1058
    );
    ClearMemSecret1((int32_t)288, tmp206);
    ClearMemSecret1((int32_t)288, tmp207);

    uint64_t *tmp1061 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288, tmp1058, tmp1061,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288, tmp1058
    );

    uint64_t *tmp1063 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288, tmp1061
    );

    uint64_t *tmp1066 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1063, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1063, tmp211,
        tmp212, (int32_t)0, kScale, tmp1066
    );
    ClearMemSecret1((int32_t)128, tmp211);
    ClearMemSecret1((int32_t)128, tmp212);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1063
    );

    uint64_t *tmp1070 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1066, tmp1070,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1066
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1070, tmp215, tmp1072
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp215);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1070
    );

    int64_t tmp1075 = (int32_t)3;

    uint64_t *tmp1076 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1072, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)288, tmp1054, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)32, tmp1072, tmp1075, tmp1076
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)288, tmp1054
    );
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1072);
    ClearMemPublic(tmp1075);

    uint64_t *tmp1080 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320, tmp1076, tmp216,
        tmp217, (int32_t)0, kScale, tmp1080
    );
    ClearMemSecret1((int32_t)320, tmp216);
    ClearMemSecret1((int32_t)320, tmp217);

    uint64_t *tmp1083 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320, tmp1080, tmp1083,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320, tmp1080
    );

    uint64_t *tmp1085 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320, tmp1083
    );

    uint64_t *tmp1088 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1085, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1085, tmp221,
        tmp222, (int32_t)0, kScale, tmp1088
    );
    ClearMemSecret1((int32_t)128, tmp221);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1085
    );
    ClearMemSecret1((int32_t)128, tmp222);

    uint64_t *tmp1092 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1088, tmp1092,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1088
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1092, tmp225, tmp1094
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1092
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp225);

    int64_t tmp1097 = (int32_t)3;

    uint64_t *tmp1098 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1094, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)320, tmp1076
    );

    uint64_t *tmp1102 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352, tmp1098, tmp226,
        tmp227, (int32_t)0, kScale, tmp1102
    );
    ClearMemSecret1((int32_t)352, tmp227);
    ClearMemSecret1((int32_t)352, tmp226);

    uint64_t *tmp1105 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352, tmp1102, tmp1105,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352, tmp1102
    );

    uint64_t *tmp1107 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352, tmp1105
    );

    uint64_t *tmp1110 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1107, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1107, tmp231,
        tmp232, (int32_t)0, kScale, tmp1110
    );
    ClearMemSecret1((int32_t)128, tmp231);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1107
    );
    ClearMemSecret1((int32_t)128, tmp232);

    uint64_t *tmp1114 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1110, tmp1114,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1110
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1114, tmp235, tmp1116
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp235);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1114
    );

    int64_t tmp1119 = (int32_t)3;

    uint64_t *tmp1120 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1116, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)352, tmp1098
    );

    uint64_t *tmp1124 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384, tmp1120, tmp236,
        tmp237, (int32_t)0, kScale, tmp1124
    );
    ClearMemSecret1((int32_t)384, tmp236);
    ClearMemSecret1((int32_t)384, tmp237);

    uint64_t *tmp1127 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384, tmp1124, tmp1127,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384, tmp1124
    );

    uint64_t *tmp1129 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384, tmp1127
    );

    uint64_t *tmp1132 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1129, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1129, tmp241,
        tmp242, (int32_t)0, kScale, tmp1132
    );
    ClearMemSecret1((int32_t)128, tmp242);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1129
    );
    ClearMemSecret1((int32_t)128, tmp241);

    uint64_t *tmp1136 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1132, tmp1136,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1132
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1136, tmp245, tmp1138
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1136
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp245);

    int64_t tmp1141 = (int32_t)3;

    uint64_t *tmp1142 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1138, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)384, tmp1120
    );
    ClearMemPublic(tmp1141);

    uint64_t *tmp1146 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416, tmp1142, tmp246,
        tmp247, (int32_t)0, kScale, tmp1146
    );
    ClearMemSecret1((int32_t)416, tmp246);
    ClearMemSecret1((int32_t)416, tmp247);

    uint64_t *tmp1149 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416, tmp1146, tmp1149,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416, tmp1146
    );

    uint64_t *tmp1151 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416, tmp1149
    );

    uint64_t *tmp1154 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1151, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1151, tmp251,
        tmp252, (int32_t)0, kScale, tmp1154
    );
    ClearMemSecret1((int32_t)128, tmp251);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1151
    );
    ClearMemSecret1((int32_t)128, tmp252);

    uint64_t *tmp1158 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1154, tmp1158,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1154
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1158, tmp255, tmp1160
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1158
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp255);

    int64_t tmp1163 = (int32_t)3;

    uint64_t *tmp1164 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1160, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)416, tmp1142
    );
    ClearMemPublic(tmp1163);

    uint64_t *tmp1168 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448, tmp1164, tmp256,
        tmp257, (int32_t)0, kScale, tmp1168
    );
    ClearMemSecret1((int32_t)448, tmp256);
    ClearMemSecret1((int32_t)448, tmp257);

    uint64_t *tmp1171 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448, tmp1168, tmp1171,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448, tmp1168
    );

    uint64_t *tmp1173 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448, tmp1171
    );

    uint64_t *tmp1176 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1173, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1173, tmp261,
        tmp262, (int32_t)0, kScale, tmp1176
    );
    ClearMemSecret1((int32_t)128, tmp261);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1173
    );
    ClearMemSecret1((int32_t)128, tmp262);

    uint64_t *tmp1180 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1176, tmp1180,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1176
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1180, tmp265, tmp1182
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1180
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp265);

    int64_t tmp1185 = (int32_t)3;

    uint64_t *tmp1186 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1182, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)448, tmp1164
    );
    ClearMemPublic(tmp1185);

    uint64_t *tmp1190 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480, tmp1186, tmp266,
        tmp267, (int32_t)0, kScale, tmp1190
    );
    ClearMemSecret1((int32_t)480, tmp266);
    ClearMemSecret1((int32_t)480, tmp267);

    uint64_t *tmp1193 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480, tmp1190, tmp1193,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480, tmp1190
    );

    uint64_t *tmp1195 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480, tmp1193
    );
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)480, (int32_t)128, tmp270);

    uint64_t *tmp1198 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1195, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1195, tmp271,
        tmp272, (int32_t)0, kScale, tmp1198
    );
    ClearMemSecret1((int32_t)128, tmp271);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1195
    );
    ClearMemSecret1((int32_t)128, tmp272);

    uint64_t *tmp1202 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1198, tmp1202,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1198
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1202, tmp275, tmp1204
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp275);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1202
    );

    int64_t tmp1207 = (int32_t)3;

    uint64_t *tmp1208 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1204, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)480, tmp1186
    );

    uint64_t *tmp1212 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, tmp1208, tmp276,
        tmp277, (int32_t)0, kScale, tmp1212
    );
    ClearMemSecret1((int32_t)512, tmp277);
    ClearMemSecret1((int32_t)512, tmp276);

    uint64_t *tmp1215 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, tmp1212, tmp1215,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, tmp1212
    );

    uint64_t *tmp1217 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, tmp1215
    );

    uint64_t *tmp1220 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1217, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1217, tmp281,
        tmp282, (int32_t)0, kScale, tmp1220
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1217
    );
    ClearMemSecret1((int32_t)128, tmp282);
    ClearMemSecret1((int32_t)128, tmp281);

    uint64_t *tmp1224 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1220, tmp1224,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1220
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1224, tmp285, tmp1226
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp285);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1224
    );

    int64_t tmp1229 = (int32_t)3;

    uint64_t *tmp1230 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1226, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)512, tmp1208, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)32, tmp1226, tmp1229, tmp1230
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, tmp1208
    );
    ClearMemPublic(tmp1229);
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1226);

    uint64_t *tmp1234 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544, tmp1230, tmp286,
        tmp287, (int32_t)0, kScale, tmp1234
    );
    ClearMemSecret1((int32_t)544, tmp287);
    ClearMemSecret1((int32_t)544, tmp286);

    uint64_t *tmp1237 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544, tmp1234, tmp1237,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544, tmp1234
    );

    uint64_t *tmp1239 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544, tmp1237
    );

    uint64_t *tmp1242 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1239, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1239, tmp291,
        tmp292, (int32_t)0, kScale, tmp1242
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1239
    );
    ClearMemSecret1((int32_t)128, tmp291);
    ClearMemSecret1((int32_t)128, tmp292);

    uint64_t *tmp1246 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1242, tmp1246,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1242
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1246, tmp295, tmp1248
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp295);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1246
    );

    int64_t tmp1251 = (int32_t)3;

    uint64_t *tmp1252 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1248, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)544, tmp1230, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)32, tmp1248, tmp1251, tmp1252
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)544, tmp1230
    );
    ClearMemPublic(tmp1251);
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1248);

    uint64_t *tmp1256 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576, tmp1252, tmp296,
        tmp297, (int32_t)0, kScale, tmp1256
    );
    ClearMemSecret1((int32_t)576, tmp296);
    ClearMemSecret1((int32_t)576, tmp297);

    uint64_t *tmp1259 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576, tmp1256, tmp1259,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576, tmp1256
    );

    uint64_t *tmp1261 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576, tmp1259
    );

    uint64_t *tmp1264 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1261, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1261, tmp301,
        tmp302, (int32_t)0, kScale, tmp1264
    );
    ClearMemSecret1((int32_t)128, tmp301);
    ClearMemSecret1((int32_t)128, tmp302);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1261
    );

    uint64_t *tmp1268 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1264, tmp1268,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1264
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1268, tmp305, tmp1270
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1268
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp305);

    int64_t tmp1273 = (int32_t)3;

    uint64_t *tmp1274 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1270, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)576, tmp1252
    );

    uint64_t *tmp1278 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608, tmp1274, tmp306,
        tmp307, (int32_t)0, kScale, tmp1278
    );
    ClearMemSecret1((int32_t)608, tmp307);
    ClearMemSecret1((int32_t)608, tmp306);

    uint64_t *tmp1281 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608, tmp1278, tmp1281,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608, tmp1278
    );

    uint64_t *tmp1283 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608, tmp1281
    );

    uint64_t *tmp1286 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1283, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1283, tmp311,
        tmp312, (int32_t)0, kScale, tmp1286
    );
    ClearMemSecret1((int32_t)128, tmp312);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1283
    );
    ClearMemSecret1((int32_t)128, tmp311);

    uint64_t *tmp1290 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1286, tmp1290,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1286
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1290, tmp315, tmp1292
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1290
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp315);

    int64_t tmp1295 = (int32_t)3;

    uint64_t *tmp1296 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1292, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)608, tmp1274
    );
    ClearMemPublic(tmp1295);

    uint64_t *tmp1300 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640, tmp1296, tmp316,
        tmp317, (int32_t)0, kScale, tmp1300
    );
    ClearMemSecret1((int32_t)640, tmp316);
    ClearMemSecret1((int32_t)640, tmp317);

    uint64_t *tmp1303 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640, tmp1300, tmp1303,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640, tmp1300
    );

    uint64_t *tmp1305 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640, tmp1303
    );
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)640, (int32_t)128, tmp320);

    uint64_t *tmp1308 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1305, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1305, tmp321,
        tmp322, (int32_t)0, kScale, tmp1308
    );
    ClearMemSecret1((int32_t)128, tmp322);
    ClearMemSecret1((int32_t)128, tmp321);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1305
    );

    uint64_t *tmp1312 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1308, tmp1312,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1308
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1312, tmp325, tmp1314
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1312
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp325);

    int64_t tmp1317 = (int32_t)3;

    uint64_t *tmp1318 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1314, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)640, tmp1296, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)32, tmp1314, tmp1317, tmp1318
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)640, tmp1296
    );
    ClearMemPublic(tmp1317);
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1314);

    uint64_t *tmp1322 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672, tmp1318, tmp326,
        tmp327, (int32_t)0, kScale, tmp1322
    );
    ClearMemSecret1((int32_t)672, tmp327);
    ClearMemSecret1((int32_t)672, tmp326);

    uint64_t *tmp1325 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672, tmp1322, tmp1325,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672, tmp1322
    );

    uint64_t *tmp1327 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672, tmp1325
    );
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)672, (int32_t)128, tmp330);

    uint64_t *tmp1330 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1327, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1327, tmp331,
        tmp332, (int32_t)0, kScale, tmp1330
    );
    ClearMemSecret1((int32_t)128, tmp332);
    ClearMemSecret1((int32_t)128, tmp331);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1327
    );

    uint64_t *tmp1334 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1330, tmp1334,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1330
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1334, tmp335, tmp1336
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp335);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1334
    );

    int64_t tmp1339 = (int32_t)3;

    uint64_t *tmp1340 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1336, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)672, tmp1318, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)32, tmp1336, tmp1339, tmp1340
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)672, tmp1318
    );
    ClearMemPublic(tmp1339);
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1336);

    uint64_t *tmp1344 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704, tmp1340, tmp336,
        tmp337, (int32_t)0, kScale, tmp1344
    );
    ClearMemSecret1((int32_t)704, tmp337);
    ClearMemSecret1((int32_t)704, tmp336);

    uint64_t *tmp1347 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704, tmp1344, tmp1347,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704, tmp1344
    );

    uint64_t *tmp1349 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704, tmp1347
    );

    uint64_t *tmp1352 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1349, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1349, tmp341,
        tmp342, (int32_t)0, kScale, tmp1352
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1349
    );
    ClearMemSecret1((int32_t)128, tmp342);
    ClearMemSecret1((int32_t)128, tmp341);

    uint64_t *tmp1356 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1352, tmp1356,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1352
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1356, tmp345, tmp1358
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1356
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp345);

    int64_t tmp1361 = (int32_t)3;

    uint64_t *tmp1362 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1358, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)704, tmp1340
    );
    ClearMemPublic(tmp1361);

    uint64_t *tmp1366 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736, tmp1362, tmp346,
        tmp347, (int32_t)0, kScale, tmp1366
    );
    ClearMemSecret1((int32_t)736, tmp347);
    ClearMemSecret1((int32_t)736, tmp346);

    uint64_t *tmp1369 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736, tmp1366, tmp1369,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736, tmp1366
    );

    uint64_t *tmp1371 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736, tmp1369
    );

    uint64_t *tmp1374 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1371, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1371, tmp351,
        tmp352, (int32_t)0, kScale, tmp1374
    );
    ClearMemSecret1((int32_t)128, tmp352);
    ClearMemSecret1((int32_t)128, tmp351);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1371
    );

    uint64_t *tmp1378 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1374, tmp1378,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1374
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1378, tmp355, tmp1380
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp355);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1378
    );

    int64_t tmp1383 = (int32_t)3;

    uint64_t *tmp1384 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1380, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)736, tmp1362
    );
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1380);

    uint64_t *tmp1388 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768, tmp1384, tmp356,
        tmp357, (int32_t)0, kScale, tmp1388
    );
    ClearMemSecret1((int32_t)768, tmp356);
    ClearMemSecret1((int32_t)768, tmp357);

    uint64_t *tmp1391 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768, tmp1388, tmp1391,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768, tmp1388
    );

    uint64_t *tmp1393 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768, tmp1391
    );

    uint64_t *tmp1396 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1393, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1393, tmp361,
        tmp362, (int32_t)0, kScale, tmp1396
    );
    ClearMemSecret1((int32_t)128, tmp362);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1393
    );
    ClearMemSecret1((int32_t)128, tmp361);

    uint64_t *tmp1400 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1396, tmp1400,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1396
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1400, tmp365, tmp1402
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp365);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1400
    );

    int64_t tmp1405 = (int32_t)3;

    uint64_t *tmp1406 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1402, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)768, tmp1384, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)32, tmp1402, tmp1405, tmp1406
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)768, tmp1384
    );
    ClearMemPublic(tmp1405);
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1402);

    uint64_t *tmp1410 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800, tmp1406, tmp366,
        tmp367, (int32_t)0, kScale, tmp1410
    );
    ClearMemSecret1((int32_t)800, tmp367);
    ClearMemSecret1((int32_t)800, tmp366);

    uint64_t *tmp1413 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800, tmp1410, tmp1413,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800, tmp1410
    );

    uint64_t *tmp1415 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800, tmp1413
    );

    uint64_t *tmp1418 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1415, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1415, tmp371,
        tmp372, (int32_t)0, kScale, tmp1418
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1415
    );
    ClearMemSecret1((int32_t)128, tmp372);
    ClearMemSecret1((int32_t)128, tmp371);

    uint64_t *tmp1422 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1418, tmp1422,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1418
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1422, tmp375, tmp1424
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1422
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp375);

    int64_t tmp1427 = (int32_t)3;

    uint64_t *tmp1428 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1424, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)800, tmp1406
    );

    uint64_t *tmp1432 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832, tmp1428, tmp376,
        tmp377, (int32_t)0, kScale, tmp1432
    );
    ClearMemSecret1((int32_t)832, tmp376);
    ClearMemSecret1((int32_t)832, tmp377);

    uint64_t *tmp1435 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832, tmp1432, tmp1435,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832, tmp1432
    );

    uint64_t *tmp1437 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832, tmp1435
    );
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)832, (int32_t)128, tmp380);

    uint64_t *tmp1440 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1437, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1437, tmp381,
        tmp382, (int32_t)0, kScale, tmp1440
    );
    ClearMemSecret1((int32_t)128, tmp382);
    ClearMemSecret1((int32_t)128, tmp381);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1437
    );

    uint64_t *tmp1444 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1440, tmp1444,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1440
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1444, tmp385, tmp1446
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp385);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1444
    );

    int64_t tmp1449 = (int32_t)3;

    uint64_t *tmp1450 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1446, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)832, tmp1428
    );

    uint64_t *tmp1454 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864, tmp1450, tmp386,
        tmp387, (int32_t)0, kScale, tmp1454
    );
    ClearMemSecret1((int32_t)864, tmp387);
    ClearMemSecret1((int32_t)864, tmp386);

    uint64_t *tmp1457 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864, tmp1454, tmp1457,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864, tmp1454
    );

    uint64_t *tmp1459 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864, tmp1457
    );

    uint64_t *tmp1462 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1459, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1459, tmp391,
        tmp392, (int32_t)0, kScale, tmp1462
    );
    ClearMemSecret1((int32_t)128, tmp392);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1459
    );
    ClearMemSecret1((int32_t)128, tmp391);

    uint64_t *tmp1466 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1462, tmp1466,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1462
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1466, tmp395, tmp1468
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp395);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1466
    );

    int64_t tmp1471 = (int32_t)3;

    uint64_t *tmp1472 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1468, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)864, tmp1450
    );
    ClearMemPublic(tmp1471);

    uint64_t *tmp1476 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896, tmp1472, tmp396,
        tmp397, (int32_t)0, kScale, tmp1476
    );
    ClearMemSecret1((int32_t)896, tmp397);
    ClearMemSecret1((int32_t)896, tmp396);

    uint64_t *tmp1479 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896, tmp1476, tmp1479,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896, tmp1476
    );

    uint64_t *tmp1481 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896, tmp1479
    );

    uint64_t *tmp1484 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1481, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1481, tmp401,
        tmp402, (int32_t)0, kScale, tmp1484
    );
    ClearMemSecret1((int32_t)128, tmp401);
    ClearMemSecret1((int32_t)128, tmp402);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1481
    );

    uint64_t *tmp1488 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1484, tmp1488,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1484
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1488, tmp405, tmp1490
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp405);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1488
    );

    int64_t tmp1493 = (int32_t)3;

    uint64_t *tmp1494 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1490, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)896, tmp1472, (int32_t)1,
        (int32_t)14, (int32_t)14, (int32_t)32, tmp1490, tmp1493, tmp1494
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)896, tmp1472
    );
    ClearMemPublic(tmp1493);
    ClearMemSecret4((int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1490);

    uint64_t *tmp1498 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928, tmp1494, tmp406,
        tmp407, (int32_t)0, kScale, tmp1498
    );
    ClearMemSecret1((int32_t)928, tmp407);
    ClearMemSecret1((int32_t)928, tmp406);

    uint64_t *tmp1501 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928, tmp1498, tmp1501,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928, tmp1498
    );

    uint64_t *tmp1503 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928, tmp1501
    );
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)928, (int32_t)128, tmp410);

    uint64_t *tmp1506 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1503, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1503, tmp411,
        tmp412, (int32_t)0, kScale, tmp1506
    );
    ClearMemSecret1((int32_t)128, tmp412);
    ClearMemSecret1((int32_t)128, tmp411);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1503
    );

    uint64_t *tmp1510 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1506, tmp1510,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1506
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1510, tmp415, tmp1512
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp415);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1510
    );

    int64_t tmp1515 = (int32_t)3;

    uint64_t *tmp1516 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1512, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)928, tmp1494
    );

    uint64_t *tmp1520 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960, tmp1516, tmp416,
        tmp417, (int32_t)0, kScale, tmp1520
    );
    ClearMemSecret1((int32_t)960, tmp416);
    ClearMemSecret1((int32_t)960, tmp417);

    uint64_t *tmp1523 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960, tmp1520, tmp1523,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960, tmp1520
    );

    uint64_t *tmp1525 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960, tmp1523
    );

    uint64_t *tmp1528 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1525, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1525, tmp421,
        tmp422, (int32_t)0, kScale, tmp1528
    );
    ClearMemSecret1((int32_t)128, tmp421);
    ClearMemSecret1((int32_t)128, tmp422);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1525
    );

    uint64_t *tmp1532 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1528, tmp1532,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1528
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1532, tmp425, tmp1534
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1532
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp425);

    int64_t tmp1537 = (int32_t)3;

    uint64_t *tmp1538 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1534, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)960, tmp1516
    );

    uint64_t *tmp1542 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992, tmp1538, tmp426,
        tmp427, (int32_t)0, kScale, tmp1542
    );
    ClearMemSecret1((int32_t)992, tmp427);
    ClearMemSecret1((int32_t)992, tmp426);

    uint64_t *tmp1545 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992, tmp1542, tmp1545,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992, tmp1542
    );

    uint64_t *tmp1547 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992, tmp1545
    );
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)992, (int32_t)128, tmp430);

    uint64_t *tmp1550 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1547, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1547, tmp431,
        tmp432, (int32_t)0, kScale, tmp1550
    );
    ClearMemSecret1((int32_t)128, tmp432);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1547
    );
    ClearMemSecret1((int32_t)128, tmp431);

    uint64_t *tmp1554 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1550, tmp1554,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1550
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1554, tmp435, tmp1556
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)128, tmp1554
    );
    ClearMemSecret4((int32_t)3, (int32_t)3, (int32_t)128, (int32_t)32, tmp435);

    int64_t tmp1559 = (int32_t)3;

    uint64_t *tmp1560 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024
    );
    ScaleDown4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)32, tmp1556, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)992, tmp1538
    );
    ClearMemPublic(tmp1559);

    uint64_t *tmp1564 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024, tmp1560, tmp436,
        tmp437, (int32_t)0, kScale, tmp1564
    );
    ClearMemSecret1((int32_t)1024, tmp437);
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024, tmp1560
    );
    ClearMemSecret1((int32_t)1024, tmp436);

    uint64_t *tmp1568 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024
    );
    Relu4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024, tmp1564, tmp1568,
        kScale, 1
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024, tmp1564
    );

    uint64_t *tmp1570 = make_array<uint64_t>(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512
    );
    Conv2DWrapper(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)1024, tmp1568
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)1, (int32_t)1024, (int32_t)512, tmp440
    );

    uint64_t *tmp1573 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512);
    AvgPool(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512, (int32_t)2,
        (int32_t)2, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)2,
        (int32_t)2, (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, tmp1570,
        tmp1573
    );
    ClearMemSecret4(
        (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)512, tmp1570
    );

    uint64_t *tmp1575 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512, tmp1573, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512, tmp1573, tmp441,
        tmp442, (int32_t)0, kScale, tmp1575
    );
    ...
    uint64_t *tmp1578 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512, tmp1575, tmp1578,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)512, (int32_t)1,
        (int32_t)1, (int32_t)128, (int32_t)0, (int32_t)0, (int32_t)0,
    ...
    uint64_t *tmp1583 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1580, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1580, tmp446,
        tmp447, (int32_t)0, kScale, tmp1583
    );
    ...
    uint64_t *tmp1587 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1583, tmp1587,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1587, tmp450, tmp1589
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1589, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)544, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)512, tmp1573, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1589, tmp1592, tmp1593
    );
    ...
    uint64_t *tmp1597 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)544);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)544, tmp1593, tmp451,
        tmp452, (int32_t)0, kScale, tmp1597
    );
    ...
    uint64_t *tmp1600 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)544);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)544, tmp1597, tmp1600,
        kScale, 1
    );
    ...
    uint64_t *tmp1605 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1602, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1602, tmp456,
        tmp457, (int32_t)0, kScale, tmp1605
    );
    ...
    uint64_t *tmp1609 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1605, tmp1609,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1609, tmp460, tmp1611
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1611, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)576, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)544, tmp1593, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1611, tmp1614, tmp1615
    );
    ...
    uint64_t *tmp1619 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)576);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)576, tmp1615, tmp461,
        tmp462, (int32_t)0, kScale, tmp1619
    );
    ...
    uint64_t *tmp1622 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)576);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)576, tmp1619, tmp1622,
        kScale, 1
    );
    ...
    uint64_t *tmp1627 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1624, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1624, tmp466,
        tmp467, (int32_t)0, kScale, tmp1627
    );
    ...
    uint64_t *tmp1631 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1627, tmp1631,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1631, tmp470, tmp1633
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1633, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)608, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)576, tmp1615, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1633, tmp1636, tmp1637
    );
    ...
    uint64_t *tmp1641 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)608);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)608, tmp1637, tmp471,
        tmp472, (int32_t)0, kScale, tmp1641
    );
    ...
    uint64_t *tmp1644 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)608);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)608, tmp1641, tmp1644,
        kScale, 1
    );
    ...
    uint64_t *tmp1649 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1646, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1646, tmp476,
        tmp477, (int32_t)0, kScale, tmp1649
    );
    ...
    uint64_t *tmp1653 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1649, tmp1653,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1653, tmp480, tmp1655
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1655, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)640, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)608, tmp1637, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1655, tmp1658, tmp1659
    );
    ...
    uint64_t *tmp1663 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)640);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)640, tmp1659, tmp481,
        tmp482, (int32_t)0, kScale, tmp1663
    );
    ...
    uint64_t *tmp1666 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)640);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)640, tmp1663, tmp1666,
        kScale, 1
    );
    ...
    uint64_t *tmp1671 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1668, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1668, tmp486,
        tmp487, (int32_t)0, kScale, tmp1671
    );
    ...
    uint64_t *tmp1675 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1671, tmp1675,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1675, tmp490, tmp1677
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1677, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)672, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)640, tmp1659, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1677, tmp1680, tmp1681
    );
    ...
    uint64_t *tmp1685 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)672);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)672, tmp1681, tmp491,
        tmp492, (int32_t)0, kScale, tmp1685
    );
    ...
    uint64_t *tmp1688 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)672);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)672, tmp1685, tmp1688,
        kScale, 1
    );
    ...
    uint64_t *tmp1693 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1690, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1690, tmp496,
        tmp497, (int32_t)0, kScale, tmp1693
    );
    ...
    uint64_t *tmp1697 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1693, tmp1697,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1697, tmp500, tmp1699
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1699, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)704, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)672, tmp1681, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1699, tmp1702, tmp1703
    );
    ...
    uint64_t *tmp1707 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)704);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)704, tmp1703, tmp501,
        tmp502, (int32_t)0, kScale, tmp1707
    );
    ...
    uint64_t *tmp1710 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)704);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)704, tmp1707, tmp1710,
        kScale, 1
    );
    ...
    uint64_t *tmp1715 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1712, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1712, tmp506,
        tmp507, (int32_t)0, kScale, tmp1715
    );
    ...
    uint64_t *tmp1719 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1715, tmp1719,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1719, tmp510, tmp1721
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1721, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)736, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)704, tmp1703, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1721, tmp1724, tmp1725
    );
    ...
    uint64_t *tmp1729 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)736);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)736, tmp1725, tmp511,
        tmp512, (int32_t)0, kScale, tmp1729
    );
    ...
    uint64_t *tmp1732 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)736);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)736, tmp1729, tmp1732,
        kScale, 1
    );
    ...
    uint64_t *tmp1737 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1734, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1734, tmp516,
        tmp517, (int32_t)0, kScale, tmp1737
    );
    ...
    uint64_t *tmp1741 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1737, tmp1741,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1741, tmp520, tmp1743
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1743, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)768, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)736, tmp1725, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1743, tmp1746, tmp1747
    );
    ...
    uint64_t *tmp1751 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)768);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)768, tmp1747, tmp521,
        tmp522, (int32_t)0, kScale, tmp1751
    );
    ...
    uint64_t *tmp1754 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)768);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)768, tmp1751, tmp1754,
        kScale, 1
    );
    ...
    uint64_t *tmp1759 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1756, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1756, tmp526,
        tmp527, (int32_t)0, kScale, tmp1759
    );
    ...
    uint64_t *tmp1763 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1759, tmp1763,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1763, tmp530, tmp1765
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1765, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)800, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)768, tmp1747, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1765, tmp1768, tmp1769
    );
    ...
    uint64_t *tmp1773 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)800);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)800, tmp1769, tmp531,
        tmp532, (int32_t)0, kScale, tmp1773
    );
    ...
    uint64_t *tmp1776 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)800);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)800, tmp1773, tmp1776,
        kScale, 1
    );
    ...
    uint64_t *tmp1781 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1778, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1778, tmp536,
        tmp537, (int32_t)0, kScale, tmp1781
    );
    ...
    uint64_t *tmp1785 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1781, tmp1785,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1785, tmp540, tmp1787
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1787, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)832, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)800, tmp1769, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1787, tmp1790, tmp1791
    );
    ...
    uint64_t *tmp1795 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)832);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)832, tmp1791, tmp541,
        tmp542, (int32_t)0, kScale, tmp1795
    );
    ...
    uint64_t *tmp1798 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)832);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)832, tmp1795, tmp1798,
        kScale, 1
    );
    ...
    uint64_t *tmp1803 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1800, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1800, tmp546,
        tmp547, (int32_t)0, kScale, tmp1803
    );
    ...
    uint64_t *tmp1807 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1803, tmp1807,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1807, tmp550, tmp1809
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1809, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)864, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)832, tmp1791, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1809, tmp1812, tmp1813
    );
    ...
    uint64_t *tmp1817 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)864);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)864, tmp1813, tmp551,
        tmp552, (int32_t)0, kScale, tmp1817
    );
    ...
    uint64_t *tmp1820 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)864);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)864, tmp1817, tmp1820,
        kScale, 1
    );
    ...
    uint64_t *tmp1825 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1822, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1822, tmp556,
        tmp557, (int32_t)0, kScale, tmp1825
    );
    ...
    uint64_t *tmp1829 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1825, tmp1829,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1829, tmp560, tmp1831
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1831, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)896, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)864, tmp1813, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1831, tmp1834, tmp1835
    );
    ...
    uint64_t *tmp1839 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)896);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)896, tmp1835, tmp561,
        tmp562, (int32_t)0, kScale, tmp1839
    );
    ...
    uint64_t *tmp1842 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)896);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)896, tmp1839, tmp1842,
        kScale, 1
    );
    ...
    uint64_t *tmp1847 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1844, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1844, tmp566,
        tmp567, (int32_t)0, kScale, tmp1847
    );
    ...
    uint64_t *tmp1851 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1847, tmp1851,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1851, tmp570, tmp1853
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1853, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)928, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)896, tmp1835, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1853, tmp1856, tmp1857
    );
    ...
    uint64_t *tmp1861 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)928);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)928, tmp1857, tmp571,
        tmp572, (int32_t)0, kScale, tmp1861
    );
    ...
    uint64_t *tmp1864 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)928);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)928, tmp1861, tmp1864,
        kScale, 1
    );
    ...
    uint64_t *tmp1869 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1866, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1866, tmp576,
        tmp577, (int32_t)0, kScale, tmp1869
    );
    ...
    uint64_t *tmp1873 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1869, tmp1873,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1873, tmp580, tmp1875
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1875, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)960, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)928, tmp1857, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1875, tmp1878, tmp1879
    );
    ...
    uint64_t *tmp1883 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)960);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)960, tmp1879, tmp581,
        tmp582, (int32_t)0, kScale, tmp1883
    );
    ...
    uint64_t *tmp1886 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)960);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)960, tmp1883, tmp1886,
        kScale, 1
    );
    ...
    uint64_t *tmp1891 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1888, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1888, tmp586,
        tmp587, (int32_t)0, kScale, tmp1891
    );
    ...
    uint64_t *tmp1895 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1891, tmp1895,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1895, tmp590, tmp1897
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1897, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)992, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)960, tmp1879, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1897, tmp1900, tmp1901
    );
    ...
    uint64_t *tmp1905 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)992);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)992, tmp1901, tmp591,
        tmp592, (int32_t)0, kScale, tmp1905
    );
    ...
    uint64_t *tmp1908 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)992);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)992, tmp1905, tmp1908,
        kScale, 1
    );
    ...
    uint64_t *tmp1913 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1910, kScale
    );
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1910, tmp596,
        tmp597, (int32_t)0, kScale, tmp1913
    );
    ...
    uint64_t *tmp1917 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, tmp1913, tmp1917,
        kScale, 1
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)128, (int32_t)3,
        (int32_t)3, (int32_t)32, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1, (int32_t)1, tmp1917, tmp600, tmp1919
    );
    ...
    ScaleDown4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)32, tmp1919, kScale
    );
    Concat2T444(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)1024, (int32_t)1,
        (int32_t)7, (int32_t)7, (int32_t)992, tmp1901, (int32_t)1, (int32_t)7,
        (int32_t)7, (int32_t)32, tmp1919, tmp1922, tmp1923
    );
    ...
    uint64_t *tmp1927 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)1024);
    FusedBatchNorm4411(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)1024, tmp1923, tmp601,
        tmp602, (int32_t)0, kScale, tmp1927
    );
    ...
    uint64_t *tmp1931 =
        make_array<uint64_t>((int32_t)1, (int32_t)7, (int32_t)7, (int32_t)1024);
    Relu4(
        (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)1024, tmp1927, tmp1931,
        kScale, 1
    );
    ...
    AvgPool(
        (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1024, (int32_t)7,
        (int32_t)7, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)0, (int32_t)1,
        (int32_t)1, (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)1024, tmp1931,
        tmp1933
    );
    ...
    Conv2DWrapper(
        (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1024, (int32_t)1,
    ...
    ClearMemSecret4(
        (int32_t)1, (int32_t)1, (int32_t)1024, (int32_t)1000, tmp605
    );

    uint64_t *tmp1938 =
        make_array<uint64_t>((int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1000);
    ScaleUp1((int32_t)1000, tmp606, kScale);
    MatAddBroadCast4(
        (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1000, tmp1935, tmp606,
        tmp1938
    );
    ...
    uint64_t *tmp1942 =
        make_array<uint64_t>((int32_t)1, (int32_t)1, (int32_t)1);
    ArgMax3(
        (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1,
        (int32_t)1000, tmp1938, tmp1941, tmp1942
    );
    ...
    for (uint64_t i0 = 0; i0 < 1000; i0++) {
        prediction_vector[i0] =
            funcReconstruct2PCCons(Arr1DIdxRowM(tmp1938, 1000, i0), 2) /
            std::pow(4., kScale);
    }
    ClearMemSecret4((int32_t)1, (int32_t)1, (int32_t)1, (int32_t)1000, tmp1938);
    if (party == CLIENT) {
        std::sort(
            prediction_vector.begin(), prediction_vector.end(),
        ...
        for (uint64_t i1 = (uint64_t)0; i1 < (int32_t)1; i1++) {
            for (uint64_t i2 = (uint64_t)0; i2 < (int32_t)1; i2++) {
                auto pred = funcReconstruct2PCCons(
                    Arr3DIdxRowM(
                        tmp1942, (int32_t)1, (int32_t)1, (int32_t)1, i0, i1, i2
                    ),
                    2
                );
                if (party == CLIENT) {
