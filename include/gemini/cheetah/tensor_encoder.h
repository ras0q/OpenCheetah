...
namespace gemini {
    ...
    class TensorEncoder {
       ...
       private:
        ...
        Code Encode(
            ...
            const TensorType &img_or_filter,
        ...
        Code A2HBFV(
            const U64 *vec, size_t len, RLWEPt &pt, const Role role, bool is_ntt
        ) const;
        ...
        Code InitPtx(RLWEPt &pt, seal::parms_id_type pid = seal::parms_id_zero)
            const;
    ...
    class ConvCoeffIndexCalculator {
       public:
        explicit ConvCoeffIndexCalculator(
            size_t poly_degree,
            TensorShape ishape,
            TensorShape fshape,
            Padding padding,
